...
class SettingsSeeder extends Seeder
{
    ...
    {
        $defaults = [
            ['key' => 'site_name',        'value' => 'Toolsearch',  'type' => 'string',  'group' => 'general', 'label' => 'Site Name'],
            ['key' => 'site_tagline',     'value' => 'Free Online Tools for Everyone', 'type' => 'string', 'group' => 'general', 'label' => 'Tagline'],
            ['key' => 'site_description', 'value' => 'Toolsearch is your all-in-one platform for free online calculators, converters, generators, and productivity tools.', 'type' => 'string', 'group' => 'general', 'label' => 'Description'],
            ['key' => 'contact_email',    'value' => '', 'type' => 'string', 'group' => 'general', 'label' => 'Contact Email'],
            ['key' => 'footer_text',      'value' => '© ' . date('Y') . ' Toolsearch. All rights reserved. Free tools for everyone.', 'type' => 'string', 'group' => 'general', 'label' => 'Footer Text'],
            ...
            ['key' => 'seo_title_suffix', 'value' => ' - Toolsearch', 'type' => 'string', 'group' => 'seo', 'label' => 'SEO Title Suffix'],
