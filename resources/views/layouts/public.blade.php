...
<head>
    ...
    <meta name="google-site-verification" content="ng2-08woywOW7u6F2XyoG6CN8ANxN61Oki2h4H5M7f8" />
    {{-- SEO --}}
    ...
    <meta property="og:locale"
        content="{{ app()->getLocale() === 'en' ? 'en_US' : str_replace('-', '_', app()->getLocale()) }}">
    ...
    @if(\App\Models\Setting::get('google_analytics'))
        <script async
            src="https://www.googletagmanager.com/gtag/js?id={{ \App\Models\Setting::get('google_analytics') }}"></script>
        <script>
                                ...
                                <div class="border border-gray-100 rounded-xl overflow-hidden">
                                    <button @click="open = open === {{ $fi }} ? null : {{ $fi }}"
                                        ...
                                        <svg class="w-4 h-4 text-gray-400 flex-shrink-0 transition-transform"
                                            :class="open === {{ $fi }} ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
