...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-16">
    ...
    <div class="card p-8 tool-prose">
        ...
        <p>By using {{ \App\Models\Setting::get('site_name', 'Toolsearch') }}, you agree to these terms. If you don't agree, please don't use our services.</p>
        <h2>Use of Tools</h2>
        ...
        <p>{{ \App\Models\Setting::get('site_name', 'Toolsearch') }} shall not be liable for any damages arising from the use of our tools or reliance on tool results.</p>
