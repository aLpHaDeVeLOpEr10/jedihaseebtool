...
@section('title', 'Privacy Policy - ' . \App\Models\Setting::get('site_name', 'JEDISEBITOOL'))
@section('content')
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-16">
    ...
    <div class="card p-8 tool-prose">
        ...
        <p>{{ \App\Models\Setting::get('site_name', 'JEDISEBITOOL') }} collects minimal information. Most tools process data entirely in your browser and never send it to our servers. When you use our contact form, we collect your name, email, and message to respond to your inquiry.</p>
        ...
        <h2>Contact</h2>
        <p>For privacy questions, contact us at <a href="mailto:{{ \App\Models\Setting::get('contact_email', 'privacy@jedisebitool.com') }}">{{ \App\Models\Setting::get('contact_email', 'privacy@jedisebitool.com') }}</a>.</p>
    </div>
</div>
@endsection
