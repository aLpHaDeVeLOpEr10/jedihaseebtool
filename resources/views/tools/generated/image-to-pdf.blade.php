    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p class="text-gray-500 mt-1">{{ $tool->short_description ?? 'Combine multiple images into a single PDF — choose page size, orientation, margins, and fitting options. Free and 100% in-browser.' }}</p>
        </div>
      </div>
      <x-breadcrumb :items="[
          ['label' => 'Home',                'url' => url('/')],
