...
@section('meta_description', $tool->description ?? 'Calculate file transfer time, required bandwidth, or data amount for any connection speed.')
    ...
    <div class="lg:grid lg:grid-cols-5 lg:gap-8 space-y-6 lg:space-y-0">
      ...
      <div class="lg:col-span-2 space-y-5">
        ...
        <div class="card p-5 space-y-4">
          ...
          {{-- File count multiplier (mode: time, speed) --}}
          ...
          {{-- Bandwidth / Speed (modes: time, data) --}}
          ...
          {{-- Transfer Time (modes: speed, data) --}}
        ...
        {{-- Quick file-size presets (visible only in time/speed mode) --}}
        ...
        {{-- Quick speed presets (visible only in time/data mode) --}}
      ...
      <div class="lg:col-span-3 space-y-5">
        ...
        <template x-if="phase==='done'">
          <div class="space-y-5 bw-in">
            ...
            {{-- Speed comparison table (mode: time / data) --}}
            ...
            {{-- Data equivalents (mode: data / time) --}}
