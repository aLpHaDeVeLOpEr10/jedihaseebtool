...
@section('meta_description', $tool->description ?? 'Free online scientific calculator with trig, log, powers, constants and more.')
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm mt-0.5">{{ $tool->description ?? 'Full-featured scientific calculator with trig, log, powers, memory and more.' }}</p>
            </div>
        </div>
    </div>
