...
{{-- Off-screen render host for html2canvas — always in DOM, never visible to user --}}
    ...
    <div class="grid gap-8 lg:grid-cols-3">
      ...
      <div class="lg:col-span-2 space-y-5" x-data="wjTool()">
        ...
        <div class="card p-6 space-y-5" x-show="!converting && !pages.length">
          ...
          {{-- Conversion error (from a previous attempt) --}}
        ...
        <div class="card p-6 space-y-5" x-show="pages.length > 0" x-transition>
          ...
          {{-- mammoth warnings (non-fatal formatting notes) --}}
...
@push('scripts')
{{-- mammoth.js: converts .docx binary to semantic HTML (browser build) --}}
<script src="https://unpkg.com/mammoth@1.6.0/mammoth.browser.min.js"></script>
{{-- html2canvas: renders a DOM element to an HTML5 canvas --}}
