      ...
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p class="text-gray-500 mt-1">
            {{ $tool->short_description ?: 'Download Facebook Reels, Videos and Stories for free — fast, no login required for public content.' }}
          </p>
        </div>
      </div>
      <x-breadcrumb :items="[
    ...
    <div class="grid gap-8 lg:grid-cols-3">
      ...
      <div class="lg:col-span-2 space-y-5" x-data="fbDownloader()">
        ...
        <div class="card p-6 space-y-5" x-show="result" x-transition>
          ...
          {{-- Video CDN failed — thumbnail + open link fallback --}}
          <template x-if="result && result.video_url && videoError">
            <div>
              <div class="flex items-center justify-between mb-2">
