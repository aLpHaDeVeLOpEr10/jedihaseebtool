...
@section('meta_description', $tool->seo_description ?? 'Calculate how long it takes to download any file at any internet speed. Instant results in days, hours, minutes, and seconds.')
      ...
      <div class="lg:col-span-3 space-y-5">
        ...
        <template x-if="phase === 'done'">
          <div class="space-y-5 dt-in">
            ...
            {{-- ── What you can download at this speed ─── --}}
