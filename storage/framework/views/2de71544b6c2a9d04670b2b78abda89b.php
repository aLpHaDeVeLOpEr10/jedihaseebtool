...
<?php $__env->startSection('title', 'Python Compiler — Run Python Code Online | JEDISEBITOOL'); ?>
<?php $__env->startSection('description', 'Free online Python compiler. Write and run Python 3 code instantly — real backend execution, live stdout/stderr output, stdin support, and syntax highlighting. No install needed.'); ?>
  ...
  <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <div class="card p-5">
      ...
      <div class="space-y-2 text-xs">
        ...
        <div class="flex items-center justify-between">
          <kbd class="px-1.5 py-0.5 bg-gray-100 border border-gray-200 rounded text-gray-600 text-xs"><?php echo e($s[0]); ?></kbd>
          <span class="text-gray-500"><?php echo e($s[1]); ?></span>
        </div>
    ...
    <div class="card p-5">
      ...
      <div class="space-y-1.5">
        <?php $__currentLoopData = $relatedTools->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route('tools.show', $related)); ?>"
          ...
          <span class="text-base"><?php echo e($related->icon); ?></span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views\tools\generated\python-compiler.blade.php ENDPATH**/ ?>