    ...
    <div class="flex items-start gap-4">
      ...
      <div>
        <div class="flex flex-wrap items-center gap-2 mb-1">
          <h1 class="text-2xl font-bold text-gray-900"><?php echo e($tool->name); ?></h1>
          <span class="dw-badge">
        ...
        <p class="text-gray-600 text-sm max-w-2xl"><?php echo e($tool->description); ?></p>
      </div>
    </div>
  </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views\tools\generated\decision-maker-wheel-game.blade.php ENDPATH**/ ?>