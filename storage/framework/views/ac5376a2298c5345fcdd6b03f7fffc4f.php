    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p class="text-gray-500 mt-1"><?php echo e($tool->short_description ?? 'Extract embedded images or convert every page to an image — free, instant, 100% in-browser.'); ?></p>
        </div>
      </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views\tools\generated\pdf-to-images.blade.php ENDPATH**/ ?>