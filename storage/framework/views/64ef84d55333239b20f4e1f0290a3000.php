    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 py-6 md:py-8">
        ...
        <div x-show="phase === 'idle'" class="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-5">
            ...
            <div class="card p-4 text-center hover:border-brand-200 transition-colors">
                <p class="text-2xl mb-1.5"><?php echo e($f['icon']); ?></p>
                <p class="text-sm font-semibold text-gray-700"><?php echo e($f['label']); ?></p>
                <p class="text-xs text-gray-400 mt-1 leading-snug"><?php echo e($f['desc']); ?></p>
            </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views\tools\generated\discount-calculator.blade.php ENDPATH**/ ?>