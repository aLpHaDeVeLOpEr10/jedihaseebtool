<?php $__env->startSection('title', $tool->seo_title ?: 'Professional PDF Editor – Annotate, Sign & Edit PDFs Free Online'); ?>
<?php $__env->startSection('description', $tool->seo_description ?: 'Full-featured browser PDF editor. Add text, shapes, signatures, highlights, images and watermarks. Merge, split, rotate pages. 100% private — nothing leaves your device.'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views/tools/generated/pdf-editor.blade.php ENDPATH**/ ?>