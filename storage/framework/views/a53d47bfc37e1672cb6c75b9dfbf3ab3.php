      ...
      <div class="space-y-6">
        ...
        <div class="card p-5">
          ...
          <div class="flex flex-wrap gap-1.5">
            <?php $__currentLoopData = ['MP4','MKV','MOV','AVI','WebM','FLV','WMV','3GP','M4V']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fmt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="text-xs font-semibold px-2 py-0.5 rounded bg-violet-50 text-violet-700 border border-violet-200"><?php echo e($fmt); ?></span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views\tools\generated\video-compressor.blade.php ENDPATH**/ ?>