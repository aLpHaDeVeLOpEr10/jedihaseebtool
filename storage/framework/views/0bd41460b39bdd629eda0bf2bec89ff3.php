...
<div x-data="{ activeTab: 'basic' }">
    ...
    <div class="flex gap-1 mb-6 border-b border-gray-200">
        <?php $__currentLoopData = [['basic', 'Basic Info'], ['seo', 'SEO'], ['content', 'Content Sections'], ['inputs', 'Inputs & FAQs'], ['blade', 'Blade Template']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$tab, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <form id="update-form" action="<?php echo e(route('admin.tools.update', $tool)); ?>" method="POST" class="space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="seo_title"
                               value="<?php echo e(old('seo_title', $tool->getRawOriginal('seo_title'))); ?>"
                               class="form-input" maxlength="200"
                               placeholder="Leave blank to auto-generate from tool name + suffix">
                        <p class="form-help">Shown in browser tab and Google results. Blank = "<?php echo e($tool->name); ?> <?php echo e(\App\Models\Setting::get('seo_title_suffix','')); ?>"</p>
                    </div>
                    <div>
                        ...
                        <textarea name="seo_description" rows="3" class="form-input" maxlength="500"
                                  placeholder="Leave blank to use short description or global default"><?php echo e(old('seo_description', $tool->getRawOriginal('seo_description'))); ?></textarea>
                        <p class="form-help">Shown as the snippet in Google search results.</p>
                    </div>
                    <div>
                        <label class="form-label">Keywords</label>
                        <input type="text" name="seo_keywords"
                               value="<?php echo e(old('seo_keywords', $tool->getRawOriginal('seo_keywords'))); ?>"
                               class="form-input" maxlength="500"
                    ...
                    <div>
                        ...
                        <input type="url" name="canonical_url"
                               value="<?php echo e(old('canonical_url', $tool->getRawOriginal('canonical_url'))); ?>"
                               class="form-input" maxlength="500"
                    ...
                    <div>
                        ...
                        <select name="robots" class="form-input">
                            <?php $currentRobots = old('robots', $tool->getRawOriginal('robots') ?? '') ?>
                            <option value="" <?php echo e($currentRobots === '' ? 'selected' : ''); ?>>Default (index, follow)</option>
                            <option value="index, follow"   <?php echo e($currentRobots === 'index, follow'   ? 'selected' : ''); ?>>index, follow</option>
                            <option value="noindex, follow" <?php echo e($currentRobots === 'noindex, follow' ? 'selected' : ''); ?>>noindex, follow</option>
                            <option value="index, nofollow" <?php echo e($currentRobots === 'index, nofollow' ? 'selected' : ''); ?>>index, nofollow</option>
                            <option value="noindex, nofollow" <?php echo e($currentRobots === 'noindex, nofollow' ? 'selected' : ''); ?>>noindex, nofollow</option>
                        </select>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="og_title"
                               value="<?php echo e(old('og_title', $tool->getRawOriginal('og_title'))); ?>"
                               class="form-input" maxlength="200"
                    ...
                    <div>
                        ...
                        <textarea name="og_description" rows="2" class="form-input" maxlength="500"
                                  placeholder="Defaults to meta description"><?php echo e(old('og_description', $tool->getRawOriginal('og_description'))); ?></textarea>
                    </div>
                    <div>
                        <label class="form-label">OG Image URL</label>
                        <input type="url" name="og_image"
                               value="<?php echo e(old('og_image', $tool->getRawOriginal('og_image'))); ?>"
                               class="form-input" maxlength="500"
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="twitter_title"
                               value="<?php echo e(old('twitter_title', $tool->getRawOriginal('twitter_title'))); ?>"
                               class="form-input" maxlength="200"
                               placeholder="Defaults to SEO title">
                    </div>
                    <div>
                        ...
                        <textarea name="twitter_description" rows="2" class="form-input" maxlength="500"
                                  placeholder="Defaults to meta description"><?php echo e(old('twitter_description', $tool->getRawOriginal('twitter_description'))); ?></textarea>
                    </div>
                </div>
            </div>
  ...
  "url": "<?php echo e($tool->url); ?>"
}'><?php echo e(old('schema_markup', $tool->getRawOriginal('schema_markup'))); ?></textarea>
        ...
        <div x-show="activeTab === 'content'" x-cloak class="space-y-6"
             x-data="contentSectionsEditor(<?php echo e($tool->contents->toJson()); ?>)">
    ...
    <form id="tool-delete-form"
          action="<?php echo e(route('admin.tools.destroy', $tool)); ?>" method="POST">
    ...
    <form id="tool-generate-blade-form"
          action="<?php echo e(route('admin.tools.generate-blade', $tool)); ?>" method="POST">
        <?php echo csrf_field(); ?>
    </form>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views\admin\tools\edit.blade.php ENDPATH**/ ?>