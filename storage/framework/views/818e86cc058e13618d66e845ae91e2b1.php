        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5 items-start">
                ...
                <div class="card p-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex justify-between text-xs">
                            <span class="font-medium text-gray-700"><?php echo e($k); ?></span>
                            <span class="text-gray-400"><?php echo e($v); ?></span>
                        </div>
            ...
            <div class="lg:col-span-3 space-y-4" id="tc-results">
                ...
                <div x-show="phase==='idle'" class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon,$label,$desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card p-4 text-center hover:border-brand-200 transition-colors">
                        <p class="text-2xl mb-1.5"><?php echo e($icon); ?></p>
                        <p class="text-sm font-semibold text-gray-700"><?php echo e($label); ?></p>
                        <p class="text-xs text-gray-400 mt-1"><?php echo e($desc); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\New folder\jedihaseebtool\resources\views\tools\generated\triangle-calculator.blade.php ENDPATH**/ ?>